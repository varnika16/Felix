...
@Component({
  selector: 'app-punmoviesdetail',
  templateUrl: './punmoviesdetail.component.html',
  styleUrls: ['./punmoviesdetail.component.scss']
})
export class PunmoviesdetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.pipe(switchMap((params: Params) => {return this.moodservice.getPunMovie(params['id'], params['pmid']); }))
    .subscribe(punMovie => {this.punMovie = punMovie; this.changePage(punMovie.id); },  errmess => this.errMess = <any>errmess);
  }
  ...
  onSubmit(){
    ...
    this.punMovie.reviews.push(this.review);
