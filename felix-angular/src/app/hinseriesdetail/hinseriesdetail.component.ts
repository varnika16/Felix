...
@Component({
  selector: 'app-hinseriesdetail',
  templateUrl: './hinseriesdetail.component.html',
  styleUrls: ['./hinseriesdetail.component.scss']
})
export class HinseriesdetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.pipe(switchMap((params: Params) => {return this.moodservice.getHinSerie(params['id'], params['htid']); }))
    .subscribe(hinSerie => {this.hinSerie = hinSerie; this.changePage(hinSerie.id); },  errmess => this.errMess = <any>errmess);
  }
  ...
  onSubmit(){
    ...
    this.hinSerie.reviews.push(this.review);
