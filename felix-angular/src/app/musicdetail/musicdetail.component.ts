...
export class MusicdetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.pipe(switchMap((params: Params) => {return this.moodservice.getMusic(params['id'], params['mid']); }))
    .subscribe(music => {this.music = music; this.changePage(music.id); },  errmess => this.errMess = <any>errmess);
  }
  ...
  onSubmit(){
    ...
    this.mood.musics.push(this.music);
