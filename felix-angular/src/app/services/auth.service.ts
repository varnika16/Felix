...
export class AuthService {
  ...
  authToken: string = undefined;
   ...
   checkJWTtoken() {
     this.http.get<JWTResponse>(baseURL2 + 'users/checkJWTtoken')
     .subscribe(res => {
   ...
   signUp(newUser: any): Observable<any> {
      return this.http.post<AuthResponse>(baseURL2+'users/signup',
   ...
   logIn(user: any): Observable<any> {
     return this.http.post<AuthResponse>(baseURL2 + 'users/login',
